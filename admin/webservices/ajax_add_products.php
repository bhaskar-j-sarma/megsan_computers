<?php
	...
	if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'add_blogs'){
		...
		if($check_result == 'no'){
	    	...
	    	$sql_insert_blogs = "INSERT INTO products(product_name, category_name, brand_name, price, url, description, tbumb_image) VALUES ('".$product_name."','".$category_name."','".$brand_name."','".$price."','".$url."','".addslashes($description)."','".$blogs_main_image."')";
