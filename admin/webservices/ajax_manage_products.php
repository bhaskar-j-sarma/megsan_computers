...
function shorten_string($string, $wordsreturned){
	...
	if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit_manage_blogs'){
		...
		$sql_update_blogs = "UPDATE products SET product_name='".$product_name."', category_name='".$category_name."', brand_name='".$brand_name."', price='".$price."',description='".addslashes($description)."', tbumb_image = '".$blogs_main_image."', url = '".$url."' WHERE id=".$_REQUEST['id'];
